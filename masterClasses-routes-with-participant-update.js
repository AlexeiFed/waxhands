...
import { authenticateToken, authorizeAdmin, authorizeRoles } from '../middleware/auth.js';
import { getMasterClassEvents, createMasterClassEvent, createMultipleMasterClassEvents, updateMasterClassEvent, deleteMasterClassEvent, updateParticipantPaymentStatus, getMasterClassEventById, updateParticipantData } from '../controllers/masterClasses.js';
...
// Обновление статуса оплаты участника (только для админов)
...
// Обновление данных участника (для родителей и админов)
router.patch('/:masterClassId/update-participant-data', authenticateToken, authorizeRoles('parent', 'admin'), updateParticipantData);
