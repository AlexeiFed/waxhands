...
export const addStyleToService = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        // Обновляем услугу
        const result = await pool.query('UPDATE services SET styles = $1, updated_at = CURRENT_TIMESTAMP WHERE id = $2 RETURNING *', [JSON.stringify(styles), id]);
...
export const addOptionToService = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        // Обновляем услугу
        const result = await pool.query('UPDATE services SET options = $1, updated_at = CURRENT_TIMESTAMP WHERE id = $2 RETURNING *', [JSON.stringify(options), id]);
...
export const updateServiceStyle = async (req, res) => {
    try {
        ...
        // Обновляем услугу
        await pool.query('UPDATE services SET styles = $1, updated_at = CURRENT_TIMESTAMP WHERE id = $2', [JSON.stringify(styles), id]);
...
export const updateServiceOption = async (req, res) => {
    try {
        ...
        // Обновляем услугу
        await pool.query('UPDATE services SET options = $1, updated_at = CURRENT_TIMESTAMP WHERE id = $2', [JSON.stringify(options), id]);
...
export const reorderServiceStyles = async (req, res) => {
    try {
        const { id } = req.params;
...
export const reorderServiceOptions = async (req, res) => {
    try {
        const { id } = req.params;
        const { order } = req.body;
...
export const deleteServiceStyle = async (req, res) => {
    try {
        ...
        const updatedStyles = currentStyles.filter((style) => style.id !== styleId);
        // Обновляем услугу с новым массивом стилей
        await pool.query('UPDATE services SET styles = $1, updated_at = CURRENT_TIMESTAMP WHERE id = $2', [JSON.stringify(updatedStyles), serviceId]);
...
export const deleteServiceOption = async (req, res) => {
    try {
        ...
        await pool.query('UPDATE services SET options = $1, updated_at = CURRENT_TIMESTAMP WHERE id = $2', [JSON.stringify(updatedOptions), serviceId]);
