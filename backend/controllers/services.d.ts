...
export declare const deleteServiceStyle: (req: Request, res: Response) => Promise<void>;
export declare const deleteServiceOption: (req: Request, res: Response) => Promise<void>;
