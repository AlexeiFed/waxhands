...
export declare class WebSocketManager {
    ...
    notifyAboutContentUpdate(contentId: string, action: string): void;
    notifyAboutMediaUpdate(mediaId: string, action: string, mediaData?: Record<string, unknown>): void;
    notifyAboutMediaAdded(mediaData: Record<string, unknown>): void;
    notifyAboutMediaDeleted(mediaId: string): void;
    getStats(): {
        totalClients: number;
        adminClients: number;
        userClients: number;
...
export declare const initializeWebSocketManager: (server: Server) => Promise<WebSocketManager>;
export {};
