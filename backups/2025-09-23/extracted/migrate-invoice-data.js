    ...
    try {
        ...
        for (const invoice of invoices) {
            ...
            if (needsUpdate) {
                ...
                await client.query(
                    'UPDATE invoices SET selected_styles = $1, selected_options = $2, updated_at = CURRENT_TIMESTAMP WHERE id = $3',
                    [JSON.stringify(updatedStyles), JSON.stringify(updatedOptions), invoice.id]
                );
            }
        }
