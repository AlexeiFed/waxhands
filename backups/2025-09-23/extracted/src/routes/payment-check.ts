...
router.get('/status/:label', authenticateToken, async (req: Request, res: Response) => {
    try {
...
router.get('/operation/:operationId', authenticateToken, async (req: Request, res: Response) => {
    try {
...
router.post('/create-form', authenticateToken, async (req: Request, res: Response) => {
    try {
