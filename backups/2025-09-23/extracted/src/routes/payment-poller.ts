 ...
 */
router.post('/check-all', authenticateToken, async (req: Request, res: Response) => {
    try {
 ...
 */
router.post('/check-invoice/:invoiceId', authenticateToken, async (req: Request, res: Response) => {
    try {
