...
const PolicyPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-wax-hands">
            ...
            <main className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 ${isParent ? 'pt-20' : ''}`}>
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 lg:p-12">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-6 sm:mb-8 bg-gradient-to-r from-orange-500 to-purple-600 bg-clip-text text-transparent">
                        Политика в отношении обработки персональных данных
                    </h1>

                    <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none text-gray-700 space-y-4 sm:space-y-6">
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">1. Общие положения</h2>
                            <p>
                                Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Тыриным Павлом Викторовичем (далее — Оператор).
                            </p>
                            <p>
                                1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.
                            </p>
                            <p>
                                1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://waxhands.ru.
                            </p>
                        </section>

                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">2. Основные понятия, используемые в Политике</h2>
                            <div className="space-y-3">
                                ...
                                <p><strong>2.3. Веб-сайт</strong> — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://waxhands.ru.</p>
                                ...
                                <p><strong>2.8. Персональные данные</strong> — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://waxhands.ru.</p>
                                ...
                                <p><strong>2.10. Пользователь</strong> — любой посетитель веб-сайта https://waxhands.ru.</p>
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">3. Основные права и обязанности Оператора</h2>
                            <div className="space-y-4">
                                <div>
                                    <h3 className="text-base sm:text-lg md:text-xl font-semibold text-purple-600 mb-2">3.1. Оператор имеет право:</h3>
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg md:text-xl font-semibold text-purple-600 mb-2">3.2. Оператор обязан:</h3>
                                    <ul className="list-disc pl-6 space-y-2">
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">4. Основные права и обязанности субъектов персональных данных</h2>
                            <div className="space-y-4">
                                <div>
                                    <h3 className="text-base sm:text-lg md:text-xl font-semibold text-purple-600 mb-2">4.1. Субъекты персональных данных имеют право:</h3>
                                    <ul className="list-disc pl-6 space-y-2">
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg md:text-xl font-semibold text-purple-600 mb-2">4.2. Субъекты персональных данных обязаны:</h3>
                                    <ul className="list-disc pl-6 space-y-2">
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">5. Принципы обработки персональных данных</h2>
                            <div className="space-y-3">
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">6. Цели обработки персональных данных</h2>
                            <div className="overflow-x-auto">
                                <table className="w-full border-collapse border border-gray-300">
                                    <thead>
                                        <tr className="bg-orange-50">
                                            <th className="border border-gray-300 p-3 text-left font-semibold">Цель обработки</th>
                                            <th className="border border-gray-300 p-3 text-left font-semibold">Персональные данные</th>
                                            <th className="border border-gray-300 p-3 text-left font-semibold">Правовые основания</th>
                                            <th className="border border-gray-300 p-3 text-left font-semibold">Виды обработки персональных данных</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td className="border border-gray-300 p-3">предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте</td>
                                            <td className="border border-gray-300 p-3">
                                                фамилия, имя, отчество<br />
                                                номера телефонов
                                            </td>
                                            <td className="border border-gray-300 p-3">Федеральный закон «Об информации, информационных технологиях и о защите информации» от 27.07.2006 N 149-ФЗ</td>
                                            <td className="border border-gray-300 p-3">Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание персональных данных</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">7. Условия обработки персональных данных</h2>
                            <div className="space-y-3">
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
                            ...
                            <div className="space-y-3">
                                ...
                                <p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a href="mailto:pavelt80@mail.ru" className="text-orange-600 hover:text-orange-700 font-semibold">pavelt80@mail.ru</a> с пометкой «Актуализация персональных данных».</p>
                                <p>8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a href="mailto:pavelt80@mail.ru" className="text-orange-600 hover:text-orange-700 font-semibold">pavelt80@mail.ru</a> с пометкой «Отзыв согласия на обработку персональных данных».</p>
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">9. Перечень действий, производимых Оператором с полученными персональными данными</h2>
                            <div className="space-y-3">
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">10. Трансграничная передача персональных данных</h2>
                            <div className="space-y-3">
                        ...
                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">11. Конфиденциальность персональных данных</h2>
                            <p>Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта персональных данных, если иное не предусмотрено федеральным законом.</p>
                        </section>

                        <section>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-600 mb-3 sm:mb-4">12. Заключительные положения</h2>
                            <div className="space-y-3">
                                <p>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a href="mailto:pavelt80@mail.ru" className="text-orange-600 hover:text-orange-700 font-semibold">pavelt80@mail.ru</a>.</p>
                                ...
                                <p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://waxhands.ru/policy" className="text-orange-600 hover:text-orange-700 font-semibold">https://waxhands.ru/policy</a>.</p>
                            </div>
                        </section>
                    </div>
                </div>
