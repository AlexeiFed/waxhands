...
router.get('/parent/:parentId', authenticateToken, requireRole('parent'), noCache, async (req, res) => {
    try {
...
router.get('/', authenticateToken, requireRole('admin'), noCache, async (req, res) => {
    try {
...
router.get('/my', authenticateToken, requireRole('parent'), noCache, async (req, res) => {
    try {
        const parent_id = req.user?.userId;
...
router.get('/stats/parent/:parentId', authenticateToken, requireRole('parent'), noCache, async (req, res) => {
    try {
        const { parentId } = req.params;
        const requestingUserId = req.user?.userId;
...
router.get('/stats/overview', authenticateToken, requireRole('admin'), noCache, async (req, res) => {
    try {
...
router.get('/:id', authenticateToken, noCache, async (req, res) => {
    try {
        const { id } = req.params;
...
router.patch('/:id/status', authenticateToken, requireRole('admin'), noCache, async (req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/:id', authenticateToken, requireRole('admin'), noCache, async (req, res) => {
    try {
        const { id } = req.params;
